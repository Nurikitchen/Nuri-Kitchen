                  ...
                  <div class="flex flex-row gap-4 w-auto shrink-0 mt-0">
                    ...
                    <button onclick="
                        document
                          .getElementById('grand-opening-modal')
                          .classList.add('hidden');
                        setTimeout(() => openPlatformSelectorModal(), 100);
...
<button onclick="exportToExcel('purchased')" class="inline-flex items-center px-4 py-2 text-[17.5px] leading-[25px] font-medium rounded-lg text-emerald-600 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 shadow-sm transition-all">
            ...
            <button onclick="openPurchasedCustomerMapModal()" class="inline-flex items-center px-4 py-2 text-[17.5px] leading-[25px] font-medium rounded-lg text-rose-600 bg-rose-50 hover:bg-rose-100 border border-rose-200 shadow-sm transition-all">
              <i class="fa-solid fa-map-location-dot mr-2"></i> Bản Đồ Ghim Vị Trí
            </button>
          ...
          <div class="sim-scrollable w-full overflow-x-clip">
            ...
            <div class="mb-6 mt-2 mx-4 md:mx-0 relative rounded-3xl bg-[#043F2E] overflow-hidden flex flex-row items-center p-5 md:p-12 text-left shadow-2xl reveal-scale">
              ...
              <div class="relative z-10 w-[60%] lg:w-[55%] pr-2 md:pr-8 mb-0">
                ...
                <!-- CTA and notice -->
                <div class="flex flex-col sm:flex-row sm:items-center gap-3 md:gap-5">
                  <button onclick="if(window.resetToSurveyForm) window.resetToSurveyForm(); else { const f = document.getElementById('diet-analysis-form'); if(f) f.scrollIntoView({ behavior: 'smooth', block: 'start' }); }" class="inline-flex items-center justify-center px-4 md:px-7 py-2.5 md:py-3.5 bg-[#059669] text-white rounded-xl font-bold text-[18px] sm:text-[15px] leading-[20px] md:text-[20px] leading-[30px] transition-all duration-300 shadow-[0_8px_20px_rgba(5,150,105,0.3)] lg:hover:-translate-y-1 active:scale-[0.98] lg:hover:shadow-lg lg:hover:bg-[#047857] whitespace-nowrap animate-glow-pulse-emerald">
            ...
            <div class="flex flex-col items-center gap-8 w-full" id="survey-main-container">
              <!-- Form (Nằm Trên - Full Viền) -->
              <div id="analysis-form-col" class="w-full space-y-6">
                <form id="diet-analysis-form" class="bg-white dark:bg-[#1e293b] rounded-3xl shadow-[0_4px_16px_rgba(15,23,42,0.05)] border border-slate-200 dark:border-slate-700/50 p-8 md:p-14 relative overflow-hidden" onsubmit="handleAnalysisSubmit(event)">
                  <!-- Progress Line -->
                  ...
                  <div id="diet-step-1" class="step-content animate-fade-in block">
                    ...
                    <div class="mb-5" id="diet-grid-1">
                      <div class="grid grid-cols-2 gap-4">
                        <label class="diet-opt-label relative cursor-pointer group transition-all duration-500" style="order: 1; view-transition-name: diet-opt-male">
                          ...
                          <div class="diet-opt-inner p-8 border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/60 rounded-2xl text-center group-hover:bg-slate-100 dark:group-hover:bg-slate-700 peer-checked:border-[#10B981] peer-checked:bg-emerald-50 dark:peer-checked:bg-emerald-900/30 transition-all flex flex-col items-center justify-center gap-4 h-80 duration-500 overflow-hidden relative">
                            <!-- Large background icon -->
                            <i class="fa-solid fa-mars absolute -right-2 -bottom-4 text-[10rem] text-indigo-500/10 transform -rotate-12 transition-transform duration-500 group-hover:scale-110 peer-checked:text-emerald-500/20 z-0"></i>

                            <!-- Small central icon -->
                            <div class="w-20 h-20 bg-indigo-100 dark:bg-indigo-900/50 text-indigo-500 dark:text-indigo-400 rounded-full flex items-center justify-center text-[50px] leading-[55px] shadow-sm peer-checked:bg-emerald-100 dark:peer-checked:bg-emerald-900/60 peer-checked:text-emerald-600 dark:peer-checked:text-emerald-400 transition-colors duration-500 relative z-10">
                              <i class="fa-solid fa-mars mt-0.5"></i>
                            </div>
                            <div class="font-bold text-slate-800 dark:text-slate-100 text-[25px] leading-[35px] relative z-10">
                              Nam
                            </div>
                          </div>
                        </label>
                        <label class="diet-opt-label relative cursor-pointer group transition-all duration-500" style="
                          ...
                          <div class="diet-opt-inner p-8 border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/60 rounded-2xl text-center group-hover:bg-slate-100 dark:group-hover:bg-slate-700 peer-checked:border-[#10B981] peer-checked:bg-emerald-50 dark:peer-checked:bg-emerald-900/30 transition-all flex flex-col items-center justify-center gap-4 h-80 duration-500 overflow-hidden relative">
                            <!-- Large background icon -->
                            <i class="fa-solid fa-venus absolute -right-2 -bottom-4 text-[10rem] text-pink-500/10 transform -rotate-12 transition-transform duration-500 group-hover:scale-110 peer-checked:text-emerald-500/20 z-0"></i>

                            <!-- Small central icon -->
                            <div class="w-20 h-20 bg-pink-100 dark:bg-pink-900/50 text-pink-500 dark:text-pink-400 rounded-full flex items-center justify-center text-[50px] leading-[55px] shadow-sm peer-checked:bg-emerald-100 dark:peer-checked:bg-emerald-900/60 peer-checked:text-emerald-600 dark:peer-checked:text-emerald-400 transition-colors duration-500 relative z-10">
                    ...
                    <div class="mt-8 animate-slide-right-4">
                      ...
                      <button id="skip-analysis-btn" type="button" onclick="window.openPlatformSelectorModal()" class="w-full bg-orange-500 text-white hover:bg-orange-600 px-6 py-3 rounded-xl font-bold text-[17.5px] leading-[25px] transition-all focus:outline-none flex items-center justify-center shadow-md hover:shadow-lg active:scale-[0.98]">
              ...
              <!-- Analysis Results (Nằm Dưới) -->
              <div id="analysis-results-col" class="w-full transition-all duration-300">
                <div id="analysis-empty-state" class="w-full flex flex-col items-center justify-center bg-slate-50 dark:bg-slate-800 rounded-3xl border border-dashed border-slate-300 dark:border-slate-700 p-8 md:p-12 text-center shadow-sm">
                ...
                <div id="analysis-result-state" class="hidden space-y-6">
                  ...
                  <!-- Return to Profile Button (Only visible when analysis was started from Profile) -->
                  <div id="profile-return-action" class="hidden mt-6">
                    <button type="button" onclick="returnToProfileFromConsulting()" class="w-full py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-2xl shadow-lg shadow-emerald-600/30 transition-all flex items-center justify-center gap-2 text-[17.5px] cursor-pointer hover:scale-[1.01] active:scale-[0.99]">
                      <i class="fa-solid fa-arrow-left"></i> Quay lại trang cá nhân
                    </button>
                  </div>

                  <!-- Recommendations -->
                  <div id="consulting-recommendations-section" class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 md:p-8 mt-6">
      ...
      <div id="view-kitchen" class="hidden animate-fade-in pb-12 bg-white dark:bg-slate-900">
        ...
        <div id="section-scroll-sequence" class="relative w-full" style="height: 200vh; max-height: 260vw;">
          <div class="sticky left-0 w-full overflow-hidden flex items-center justify-center bg-white px-4 md:px-8" style="top: max(0px, 50vh - 65vw); height: 100vh; max-height: 130vw;">
...
<!-- 3. Tư vấn Gói Ăn (3 Size + Self-Mix) -->
        ...
        <div class="py-16 md:py-24 bg-slate-50 dark:bg-slate-800/50">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div id="customer-portal-features-banner" class="mt-12 w-full bg-gradient-to-br from-emerald-900 via-teal-950 to-emerald-900 rounded-[32px] p-6 md:p-10 text-white shadow-2xl border border-emerald-700/50 relative overflow-hidden">
              ...
              <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 relative z-10">
                ...
                <!-- Cột Phải: Hiển thị Mẫu Mô Tả Trang Cá Nhân Full Viền (Full Right Container, không màn hình giả lập phone) -->
        ...
        <!-- Phần Hoạt Ảnh Cuộn -->
        <div id="scroll-animation-wrapper" style="height: 300vh; max-height: 390vw; position: relative;">
          <div id="scroll-animation-sticky" style="position: sticky; top: max(0px, 50vh - 65vw); width: 100%; height: 100vh; max-height: 130vw; overflow: hidden; background-color: transparent; display: flex; align-items: center; justify-content: center; z-index: 20;">
            <div style="position: relative; width: 100%; height: 100%; max-width: 1400px; margin: 0 auto; display: flex; align-items: center; justify-content: center;">
              ...
              <div id="curtain-top" class="absolute top-0 left-0 w-full h-1/2 bg-white z-40 flex items-start justify-center pt-8 shadow-[0_10px_30px_rgba(0,0,0,0.02)] origin-top">
              ...
              <div id="curtain-bottom" class="absolute bottom-0 left-0 w-full h-1/2 bg-[#064e3b] z-40 origin-bottom">
              </div>
              ...
              <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-7xl px-4 sm:px-6 lg:px-8 z-10">
                ...
                <!-- Image 3 (Trái qua) -->
                <img id="anim-img-3" src="./images/A3.png" class="absolute -left-[6%] top-[20%] w-[36%] object-contain z-0 pointer-events-none" style="transform: translateX(-150vw);" alt="Dumbbells">

                <!-- Image 2 (Phải qua) -->
                <img id="anim-img-2" src="./images/A2.png" class="absolute -right-[5%] top-[4%] w-[41%] object-contain z-0 pointer-events-none" style="transform: translateX(150vw);" alt="Yoga Mat">
...
<div class="relative mt-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div id="view-customer-profile" class="hidden animate-fade-in pb-12 bg-white dark:bg-slate-900 transition-colors">
        <div id="customer-profile-wrapper" class="w-full transition-all duration-300 relative mx-auto max-w-full bg-white dark:bg-slate-800 min-h-screen shadow-none pt-0 overflow-hidden">
          ...
          <div id="customer-profile-body-container" class="px-4 sm:px-6 md:px-8 py-4 flex flex-col items-center relative z-10 -mt-20 w-full max-w-full">
          ...
          <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 mb-8 overflow-hidden relative">
            <div class="mb-4 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              <div>
                ...
                <p class="text-slate-500 text-[15px] leading-[22px] mt-1">
                  Hiển thị vị trí cửa hàng và khách hàng đã ghim vị trí, lọc đơn hàng hỗ trợ tối ưu logistics.
                </p>
              </div>
              <div class="flex flex-wrap items-center gap-3">
                <div class="flex items-center gap-2 bg-slate-50 p-1.5 rounded-xl border border-slate-200">
                  <span class="text-xs font-bold text-slate-600 px-2 flex items-center gap-1"><i class="fa-solid fa-filter text-emerald-600"></i> Lọc:</span>
                  <select id="density-map-filter" onchange="filterShipperDensityMap()" class="text-xs font-semibold py-1.5 px-2.5 rounded-lg border border-slate-300 bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 cursor-pointer">
                ...
                <button onclick="analyzeLocationsWithAI()" id="btn-analyze-map" class="inline-flex items-center px-4 py-2 text-[15px] leading-[20px] font-bold rounded-xl text-white bg-emerald-500 hover:bg-emerald-600 shadow-sm transition-all whitespace-nowrap cursor-pointer">
                  <i class="fa-solid fa-wand-magic-sparkles mr-2"></i> Phân tích bằng Nuri
                </button>
              </div>
            </div>
            <div id="customer-density-map" class="h-[420px] w-full rounded-xl bg-slate-100 relative z-0 flex items-center justify-center border border-slate-200 shadow-inner">
...
`,x=`
    ...
    <div id="chatbot-fab" class="fixed bottom-6 right-[calc(max(1rem,(100vw-1280px)/2+1rem))] sm:right-[calc(max(1.5rem,(100vw-1280px)/2+1.5rem))] z-[85] flex flex-col items-center gap-3 transition-all duration-300">
      <!-- Floating Grand Opening Discount Icon (positioned above Chatbot Mascot) -->
    ...
    <!-- Nuri Chatbot Window -->
    <div id="chatbot-window" class="fixed bottom-0 left-0 sm:inset-0 sm:m-auto z-[100] w-full sm:w-[calc(100%-2rem)] max-w-[1216px] h-[85vh] sm:max-h-[85vh] bg-white rounded-t-3xl sm:rounded-3xl shadow-[0_0_0_9999px_rgba(15,23,42,0.6)] border-0 sm:border border-slate-200 hidden flex flex-col transition-all overflow-hidden">
      <!-- Header -->
      <div class="bg-gradient-to-br from-emerald-900 to-teal-700 p-4 flex justify-between items-center text-white shrink-0 shadow-sm z-10 relative">
        ...
        <button onclick="toggleChat()" class="text-white/70 hover:text-white transition-colors relative z-10 w-8 h-8 flex items-center justify-center rounded-full hover:bg-white/10">
          <i class="fa-solid fa-xmark text-[22.5px] leading-[35px]"></i>
        </button>
      </div>
      <!-- Messages Area -->
      <div id="chatbot-messages" class="flex-1 overflow-y-auto min-h-0 p-4 bg-slate-50 flex flex-col gap-4 custom-scrollbar" style="-webkit-overflow-scrolling: touch">
        <!-- Welcome Message -->
    ...
    <div id="order-platform-modal" class="fixed inset-0 z-[110] hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      ...
      <div class="fixed inset-0 z-10 overflow-y-auto">
        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
          <div class="relative transform overflow-hidden rounded-3xl bg-white text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-7xl border border-slate-100">
...
\r
        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
          <div class="relative transform overflow-hidden rounded-3xl bg-white text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-md border border-slate-100">
            ...
            <div class="p-6 md:p-8">
              ...
              <div class="space-y-4">
                  <!-- Nuri Web -->
                  <a href="#" id="btn-nuriweb" onclick="closePlatformSelectorModal(); if(window.switchView) window.switchView('order-form'); return false;" class="flex items-center gap-4 p-4 rounded-xl border border-emerald-200 bg-emerald-50 hover:bg-emerald-100 transition-colors">
    ...
    <!-- Customer Location Pin Modal -->
    <div id="customer-pin-modal" class="fixed inset-0 z-[200] bg-slate-900/60 backdrop-blur-sm hidden items-center justify-center p-4">
      <div class="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
        <div class="px-5 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50">
          <div>
            <h3 class="font-bold text-slate-800 text-lg flex items-center gap-2">
              <i class="fa-solid fa-location-dot text-rose-500"></i> Ghim vị trí giao hàng khách mua gói
            </h3>
            <p id="pin-modal-customer-info" class="text-xs text-slate-500 font-medium mt-0.5"></p>
          </div>
          <button type="button" onclick="closeCustomerPinModal()" class="text-slate-400 hover:text-slate-600">
            <i class="fa-solid fa-times text-2xl"></i>
          </button>
        </div>

        <div class="p-4 bg-slate-50 border-b border-slate-100 flex flex-col gap-2">
          <div class="flex items-center justify-between gap-3">
            <div class="flex-1 min-w-0">
              <div class="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">Địa chỉ đăng ký:</div>
              <div id="pin-modal-address" class="text-sm font-semibold text-slate-800 truncate bg-white p-2 rounded-lg border border-slate-200"></div>
            </div>
            <button type="button" onclick="aiGeocodeCustomerAddress()" class="px-3.5 py-2.5 rounded-xl font-bold text-xs text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 shadow-md flex items-center gap-2 shrink-0 transition-all">
              <i class="fa-solid fa-wand-magic-sparkles text-amber-300 animate-pulse"></i> AI Định vị từ Địa chỉ
            </button>
          </div>
          <div class="text-[12px] text-slate-500 italic flex items-center justify-between gap-2">
            <span><i class="fa-solid fa-hand-pointer mr-1 text-indigo-500"></i> Hoặc click/kéo ghim trên bản đồ để chọn thủ công</span>
            <span id="pin-coords-display" class="font-mono font-bold text-slate-700 bg-slate-200 px-2 py-0.5 rounded text-[11px]"></span>
          </div>
        </div>

        <div class="p-0 relative flex-1 min-h-[350px]">
          <div id="customer-pin-map" class="w-full h-full min-h-[350px] bg-slate-100 z-10"></div>
        </div>

        <div class="p-4 bg-slate-50 border-t border-slate-100 flex justify-between items-center">
          <button type="button" onclick="closeCustomerPinModal()" class="px-4 py-2 rounded-lg font-semibold text-slate-600 bg-white border border-slate-200 hover:bg-slate-100">
            Hủy
          </button>
          <button type="button" onclick="saveCustomerLocationPin()" class="px-5 py-2 rounded-lg font-bold text-white bg-rose-500 hover:bg-rose-600 shadow-md flex items-center gap-2">
            <i class="fa-solid fa-floppy-disk"></i> Lưu vị trí đã ghim
          </button>
        </div>
      </div>
    </div>

    <!-- All Purchased Customers Map Modal -->
    <div id="all-purchased-map-modal" class="fixed inset-0 z-[200] bg-slate-900/60 backdrop-blur-sm hidden items-center justify-center p-4">
      <div class="bg-white rounded-2xl shadow-xl w-full max-w-5xl overflow-hidden flex flex-col h-[85vh]">
        <div class="px-5 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h3 class="font-bold text-slate-800 text-lg">Bản đồ vị trí Khách Hàng Đã Mua Gói</h3>
              <p id="all-purchased-map-stats" class="text-xs text-slate-500 font-medium"></p>
            </div>
          </div>
          <button type="button" onclick="closePurchasedCustomerMapModal()" class="text-slate-400 hover:text-slate-600">
            <i class="fa-solid fa-times text-2xl"></i>
          </button>
        </div>

        <div class="p-0 relative flex-1">
          <div id="all-purchased-leaflet-map" class="w-full h-full bg-slate-100 z-10"></div>
        </div>
        ...
        <div class="p-3 bg-slate-50 border-t border-slate-100 flex justify-between items-center px-6">
          <div class="text-xs text-slate-500 flex items-center gap-4">
            <span class="flex items-center gap-1.5"><span class="w-3 h-3 rounded-full bg-emerald-500 inline-block"></span> Đang hoạt động</span>
            <span class="flex items-center gap-1.5"><span class="w-3 h-3 rounded-full bg-red-500 inline-block"></span> Đã hết hạn</span>
          </div>
          <button type="button" onclick="closePurchasedCustomerMapModal()" class="px-5 py-2 rounded-lg font-bold text-slate-700 bg-white border border-slate-200 hover:bg-slate-100">
            Đóng
          </button>
        </div>
      </div>
    ...
    <!-- Modal: Share Streak (Khoe Ngay) & Social Platforms & Reward Points -->
    <div id="share-modal" class="fixed inset-0 z-[120] hidden items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fade-in" onclick="if(event.target === this) closeShareModal()">
      <div class="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden relative border border-slate-100 dark:border-slate-700 transform transition-all animate-scale-up">
        <!-- Close Button -->
        <button type="button" onclick="closeShareModal()" class="absolute top-4 right-4 w-9 h-9 bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-300 rounded-full flex items-center justify-center hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors z-10">
          <i class="fa-solid fa-xmark text-lg"></i>
        </button>

        <div class="p-6 md:p-8 text-center">
          <!-- Header Icon & Badge -->
          <div class="w-16 h-16 bg-amber-100 dark:bg-amber-900/40 text-amber-500 rounded-full flex items-center justify-center text-3xl mx-auto mb-3 shadow-inner">
            🔥
          </div>
          <h3 class="text-2xl font-black text-slate-900 dark:text-white mb-1">Khoe Thành Tích Ăn Lành Mạnh!</h3>
          <p class="text-slate-500 dark:text-slate-400 text-sm mb-4">
            Chia sẻ lên Mạng xã hội để nhận ngay <span class="font-extrabold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/40 px-2 py-0.5 rounded-full border border-emerald-200 dark:border-emerald-800">+20 điểm tích lũy</span> 🎉
          </p>

          <!-- Pre-filled Status Textarea -->
          <div class="mb-5 text-left">
            <label class="block text-xs font-bold text-slate-600 dark:text-slate-400 mb-1.5 uppercase tracking-wider">
              <i class="fa-solid fa-pen-to-square text-emerald-600 mr-1"></i> Nội dung Status (Đã tạo sẵn):
            </label>
            <div class="relative">
              <textarea id="streak-status-text" rows="4" readonly class="w-full bg-slate-50 dark:bg-slate-900/70 border border-slate-200 dark:border-slate-700 rounded-2xl p-3.5 text-sm font-medium text-slate-700 dark:text-slate-200 focus:outline-none resize-none leading-relaxed select-all">🔥 Tôi đã hoàn thành chuỗi 7 ngày ăn uống lành mạnh cùng Nuri Kitchen! Thực đơn chuẩn calo, ngon miệng và tràn đầy năng lượng mỗi ngày. Cùng làm quen lối sống xanh với mình nhé! #Nurikitchen</textarea>
              <button type="button" onclick="copyStreakStatusText()" class="absolute right-3 bottom-3 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold px-3 py-1.5 rounded-xl shadow-sm transition-all active:scale-95 flex items-center gap-1.5">
                <i class="fa-solid fa-copy"></i> <span id="copy-status-btn-text">Sao chép status</span>
              </button>
            </div>
          </div>

          <!-- Social Platforms Buttons Grid -->
          <div class="mb-4">
            <label class="block text-xs font-bold text-slate-600 dark:text-slate-400 mb-2 uppercase tracking-wider text-left">
              <i class="fa-solid fa-share-nodes text-emerald-600 mr-1"></i> Chọn nền tảng chia sẻ:
            </label>
            <div class="grid grid-cols-3 gap-3">
              <!-- Facebook -->
              <button type="button" onclick="shareStreakPlatform('facebook')" class="flex flex-col items-center justify-center p-3.5 bg-blue-50 dark:bg-blue-950/40 hover:bg-blue-100 dark:hover:bg-blue-900/50 border border-blue-200 dark:border-blue-800 rounded-2xl text-blue-600 dark:text-blue-400 font-bold text-xs gap-2 transition-all hover:-translate-y-0.5 active:scale-95 shadow-sm">
                <div class="w-10 h-10 bg-blue-600 text-white rounded-full flex items-center justify-center text-xl shadow-md">
              ...
              <!-- Zalo -->
              <button type="button" onclick="shareStreakPlatform('zalo')" class="flex flex-col items-center justify-center p-3.5 bg-sky-50 dark:bg-sky-950/40 hover:bg-sky-100 dark:hover:bg-sky-900/50 border border-sky-200 dark:border-sky-800 rounded-2xl text-sky-600 dark:text-sky-400 font-bold text-xs gap-2 transition-all hover:-translate-y-0.5 active:scale-95 shadow-sm">
                <div class="w-10 h-10 bg-sky-500 text-white rounded-full flex items-center justify-center text-lg font-black shadow-md">
                  Zalo
                </div>
                <span>Zalo</span>
              </button>
              ...
              <!-- Instagram -->
              <button type="button" onclick="shareStreakPlatform('instagram')" class="flex flex-col items-center justify-center p-3.5 bg-pink-50 dark:bg-pink-950/40 hover:bg-pink-100 dark:hover:bg-pink-900/50 border border-pink-200 dark:border-pink-800 rounded-2xl text-pink-600 dark:text-pink-400 font-bold text-xs gap-2 transition-all hover:-translate-y-0.5 active:scale-95 shadow-sm">
                <div class="w-10 h-10 bg-gradient-to-tr from-amber-500 via-rose-500 to-purple-600 text-white rounded-full flex items-center justify-center text-xl shadow-md">
          ...
          <!-- Notice Badge -->
          <div id="share-streak-reward-status" class="bg-amber-50 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 text-xs font-semibold p-3 rounded-xl border border-amber-200 dark:border-amber-800/60 flex items-center justify-center gap-2">
            <i class="fa-solid fa-gift text-amber-500"></i>
            <span>Mỗi tài khoản được cộng +20 điểm thưởng khoe chuỗi 1 lần mỗi 7 ngày</span>
          </div>
        </div>
      </div>
    </div>

    <!-- Modal: Nhập món ăn thêm & AI Phân tích -->
    <div id="add-calorie-modal" class="fixed inset-0 z-[110] hidden items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-fade-in" onclick="if(event.target === this) window.closeAddCalorieModal()">
      <div class="relative w-full max-w-lg bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-100 flex flex-col max-h-[90vh]">
        <!-- Header -->
        <div class="bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 p-5 text-white flex justify-between items-center shrink-0 shadow-md">
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-2xl bg-white/20 backdrop-blur-md flex items-center justify-center text-xl shadow-inner">
              <i class="fa-solid fa-utensils text-emerald-100"></i>
            </div>
            <div>
              <h3 class="font-black text-lg leading-tight">Nhập món ăn thêm</h3>
              <p class="text-xs text-emerald-100 font-medium">Tự động phân tích Kcal bằng AI hoặc nhập thủ công</p>
            </div>
          </div>
          <button type="button" onclick="window.closeAddCalorieModal()" class="w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center text-white transition-colors">
            <i class="fa-solid fa-xmark text-lg"></i>
          </button>
        </div>
        ...
        <div class="p-6 overflow-y-auto space-y-4 text-left">
          ...
          <!-- 1. Photo Upload / Dropzone -->
          <div>
            <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">
              <i class="fa-solid fa-camera text-emerald-600 mr-1"></i> Tải lên ảnh món ăn (Cho AI xem & phân tích)
            </label>
            <div id="add-food-dropzone" onclick="document.getElementById('add-food-file-input').click()" class="border-2 border-dashed border-slate-300 hover:border-emerald-500 bg-slate-50 hover:bg-emerald-50/50 rounded-2xl p-4 text-center cursor-pointer transition-all flex flex-col items-center justify-center relative overflow-hidden group min-h-[110px]">
              <input type="file" id="add-food-file-input" accept="image/*" class="hidden" onchange="window.handleAddFoodImageSelect(event)">
              <div id="add-food-upload-prompt" class="flex flex-col items-center gap-1">
                <div class="w-10 h-10 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center text-lg group-hover:scale-110 transition-transform">
                  <i class="fa-solid fa-cloud-arrow-up"></i>
                </div>
                <span class="text-xs font-bold text-slate-700">Chạm để chọn ảnh món ăn</span>
                <span class="text-[10px] text-slate-400">PNG, JPG, WEBP (Tối đa 5MB)</span>
              </div>
              <div id="add-food-preview-wrapper" class="hidden relative w-full h-36">
                <img id="add-food-preview-img" src="" class="w-full h-full object-cover rounded-xl shadow-md">
                <button type="button" onclick="event.stopPropagation(); window.removeAddFoodImage();" class="absolute top-2 right-2 bg-red-600 text-white w-7 h-7 rounded-full flex items-center justify-center shadow-lg hover:bg-red-700 transition-colors text-xs font-bold">
                  <i class="fa-solid fa-xmark"></i>
                </button>
              </div>
            </div>
          ...
          <div>
            <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">
              <i class="fa-solid fa-bowl-food text-emerald-600 mr-1"></i> Tên món ăn <span class="text-red-500">*</span>
            </label>
            <input type="text" id="add-food-name" placeholder="Ví dụ: Phở bò tái chín, Bún chả, Cơm tấm..." class="w-full border border-slate-300 rounded-xl px-4 py-2.5 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-slate-50">
          </div>

          <!-- 3. Portion / Component Description -->
          <div>
            <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">
              <i class="fa-solid fa-scale-balanced text-emerald-600 mr-1"></i> Kích thước & Mô tả thành phần
            </label>
            <input type="text" id="add-food-portion" placeholder="Ví dụ: 1 tô vừa, thêm 1 trứng chần, nhiều thịt..." class="w-full border border-slate-300 rounded-xl px-4 py-2.5 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-slate-50">
          </div>

          <!-- 4. AI Analysis Button & Loading State -->
          <div>
            <button type="button" id="btn-ai-analyze-food" onclick="window.analyzeFoodWithAI()" class="w-full bg-gradient-to-r from-purple-600 via-indigo-600 to-emerald-600 text-white font-black py-3 px-4 rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.01] active:scale-[0.99] transition-all flex items-center justify-center gap-2 cursor-pointer border border-white/20">
              <i class="fa-solid fa-wand-magic-sparkles text-amber-300 animate-pulse"></i>
              <span>✨ AI Phân Tích Kcal & Dinh Dưỡng</span>
            </button>
            <div id="ai-food-loading" class="hidden mt-2 p-3 bg-purple-50 rounded-xl border border-purple-200 flex items-center justify-center gap-3 text-purple-700 text-xs font-bold animate-pulse">
              <i class="fa-solid fa-spinner fa-spin text-purple-600 text-base"></i>
              <span>AI đang phân tích hình ảnh & tính toán lượng Kcal...</span>
            </div>
          </div>

          <!-- 5. Kcal Input (Manual or AI Auto-filled) -->
          <div class="pt-2 border-t border-slate-100">
            <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">
              <i class="fa-solid fa-fire text-amber-500 mr-1"></i> Số lượng Kcal món ăn <span class="text-red-500">*</span>
            </label>
            <div class="relative">
              <input type="number" id="add-food-kcal" min="0" max="5000" placeholder="VD: 550" class="w-full border border-slate-300 rounded-xl px-4 py-3 text-lg font-black text-amber-600 focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-amber-50/40 pr-16 transition-all">
              <span class="absolute right-4 top-1/2 -translate-y-1/2 text-xs font-bold text-slate-400">kcal</span>
            </div>
          </div>

          <!-- 6. Macronutrients (Optional / AI Auto-filled) -->
          <div class="grid grid-cols-3 gap-2 pt-1">
            <div>
              <label class="block text-[11px] font-bold text-slate-500 mb-1">Đạm (Protein)</label>
              <div class="relative">
                <input type="number" id="add-food-protein" min="0" placeholder="0" class="w-full border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs font-bold text-red-500 bg-slate-50 text-center">
                <span class="absolute right-2 top-1/2 -translate-y-1/2 text-[10px] text-slate-400">g</span>
              </div>
            </div>
            <div>
              <label class="block text-[11px] font-bold text-slate-500 mb-1">Tinh bột (Carb)</label>
              <div class="relative">
                <input type="number" id="add-food-carbs" min="0" placeholder="0" class="w-full border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs font-bold text-blue-500 bg-slate-50 text-center">
                <span class="absolute right-2 top-1/2 -translate-y-1/2 text-[10px] text-slate-400">g</span>
              </div>
            </div>
            <div>
              <label class="block text-[11px] font-bold text-slate-500 mb-1">Béo (Fat)</label>
              <div class="relative">
                <input type="number" id="add-food-fat" min="0" placeholder="0" class="w-full border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs font-bold text-yellow-600 bg-slate-50 text-center">
                <span class="absolute right-2 top-1/2 -translate-y-1/2 text-[10px] text-slate-400">g</span>
              </div>
            </div>
          </div>

          <!-- 7. Select Day of Week -->
          <div>
            <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">
              <i class="fa-solid fa-calendar-day text-emerald-600 mr-1"></i> Ngày áp dụng trong tuần
            </label>
            <select id="add-food-day" class="w-full border border-slate-300 rounded-xl px-4 py-2.5 text-xs font-bold text-slate-800 bg-slate-50 focus:outline-none focus:ring-2 focus:ring-emerald-500 cursor-pointer">
              <option value="bar-t2">Thứ 2</option>
              <option value="bar-t3">Thứ 3</option>
              <option value="bar-t4">Thứ 4</option>
              <option value="bar-t5">Thứ 5</option>
              <option value="bar-t6">Thứ 6</option>
              <option value="bar-t7">Thứ 7</option>
              <option value="bar-cn">Chủ nhật</option>
            </select>
          </div>
        ...
        <div class="p-4 bg-slate-50 border-t border-slate-100 flex gap-3 shrink-0">
          <button type="button" onclick="window.closeAddCalorieModal()" class="flex-1 bg-white hover:bg-slate-100 border border-slate-300 text-slate-700 font-bold py-3 rounded-xl transition-colors text-xs">
            Hủy
          </button>
          <button type="button" onclick="window.saveExtraFoodItem()" class="flex-[2] bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 rounded-xl shadow-md transition-all text-xs flex items-center justify-center gap-2 active:scale-95">
            <i class="fa-solid fa-check"></i> Lưu & Cập Nhật Biểu Đồ
          </button>
        </div>
      </div>
    </div>
